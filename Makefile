...
FUNCTORLIST    = $(SRCDIR)/GooPdf.cu $(SRCDIR)/AddPdf.cu $(SRCDIR)/GaussianPdf.cu $(SRCDIR)/PolynomialPdf.cu $(SRCDIR)/DalitzPlotPdf.cu $(SRCDIR)/DalitzVetoPdf.cu $(SRCDIR)/ResonancePdf.cu $(SRCDIR)/TddpPdf.cu $(SRCDIR)/MixingTimeResolution_Aux.cu
